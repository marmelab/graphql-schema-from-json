(function (global, factory) {
	...
	var assertValidName_3 = assertValidName_1.formatWarning;
	...
	var definition_1 = definition.GraphQLNonNull;
	var definition_2 = definition.GraphQLList;
	var definition_3 = definition.GraphQLInputObjectType;
	var definition_4 = definition.GraphQLEnumType;
	var definition_5 = definition.GraphQLUnionType;
	var definition_6 = definition.GraphQLInterfaceType;
	var definition_7 = definition.GraphQLObjectType;
	var definition_8 = definition.GraphQLScalarType;
	var definition_9 = definition.isType;
	var definition_10 = definition.assertType;
	var definition_11 = definition.isInputType;
	var definition_12 = definition.assertInputType;
	var definition_13 = definition.isOutputType;
	var definition_14 = definition.assertOutputType;
	var definition_15 = definition.isLeafType;
	var definition_16 = definition.assertLeafType;
	var definition_17 = definition.isCompositeType;
	var definition_18 = definition.assertCompositeType;
	var definition_19 = definition.isAbstractType;
	var definition_20 = definition.assertAbstractType;
	var definition_21 = definition.getNullableType;
	var definition_22 = definition.isNamedType;
	var definition_23 = definition.assertNamedType;
	var definition_24 = definition.getNamedType;
	...
	var scalars_1 = scalars.GraphQLID;
	var scalars_2 = scalars.GraphQLBoolean;
	var scalars_3 = scalars.GraphQLString;
	var scalars_4 = scalars.GraphQLFloat;
	var scalars_5 = scalars.GraphQLInt;
	...
	var directives_1 = directives.specifiedDirectives;
	var directives_2 = directives.GraphQLDeprecatedDirective;
	var directives_3 = directives.DEFAULT_DEPRECATION_REASON;
	var directives_4 = directives.GraphQLSkipDirective;
	var directives_5 = directives.GraphQLIncludeDirective;
	var directives_6 = directives.GraphQLDirective;
	var directives_7 = directives.DirectiveLocation;
	...
	var introspection_1 = introspection.TypeNameMetaFieldDef;
	var introspection_2 = introspection.TypeMetaFieldDef;
	var introspection_3 = introspection.SchemaMetaFieldDef;
	var introspection_4 = introspection.__TypeKind;
	var introspection_5 = introspection.TypeKind;
	var introspection_6 = introspection.__EnumValue;
	var introspection_7 = introspection.__InputValue;
	var introspection_8 = introspection.__Field;
	var introspection_9 = introspection.__Type;
	var introspection_10 = introspection.__DirectiveLocation;
	var introspection_11 = introspection.__Directive;
	var introspection_12 = introspection.__Schema;
	...
	var schema_1 = schema.GraphQLSchema;
	...
	var ArgumentsOfCorrectType_2 = ArgumentsOfCorrectType_1.badValueMessage;
	var ArgumentsOfCorrectType_3 = ArgumentsOfCorrectType_1.ArgumentsOfCorrectType;
	...
	var ProvidedNonNullArguments_2 = ProvidedNonNullArguments_1.missingFieldArgMessage;
	var ProvidedNonNullArguments_3 = ProvidedNonNullArguments_1.missingDirectiveArgMessage;
	var ProvidedNonNullArguments_4 = ProvidedNonNullArguments_1.ProvidedNonNullArguments;
	...
	var DefaultValuesOfCorrectType_2 = DefaultValuesOfCorrectType_1.defaultForNonNullArgMessage;
	var DefaultValuesOfCorrectType_3 = DefaultValuesOfCorrectType_1.badValueForDefaultArgMessage;
	var DefaultValuesOfCorrectType_4 = DefaultValuesOfCorrectType_1.DefaultValuesOfCorrectType;
	...
	var validate_2 = validate_1.ValidationContext;
	var validate_3 = validate_1.validate;
	...
	var values$2 = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(values$2);
	var values_1 = values$2.getVariableValues;
	var values_2 = values$2.getArgumentValues;
	var values_3 = values$2.getDirectiveValues;
	var values_4 = values$2.coerceValue;
	...
	function buildExecutionContext(schema, document, rootValue, contextValue, rawVariableValues, operationName, fieldResolver) {
	  ...
	  document.definitions.forEach(function (definition) {
	    switch (definition.kind) {
	      ...
	      case Kind.FRAGMENT_DEFINITION:
	        ...
	        break;
	      default:
	        throw new error.GraphQLError('GraphQL cannot execute a request containing a ' + definition.kind + '.', [definition]);
	    }
	  });
	  if (!operation) {
	    if (operationName) {
	  ...
	  var variableValues = (0, values$2.getVariableValues)(schema, operation.variableDefinitions || [], rawVariableValues || {});
	...
	function shouldIncludeNode(exeContext, node) {
	  var skip = (0, values$2.getDirectiveValues)(directives.GraphQLSkipDirective, node, exeContext.variableValues);
	  if (skip && skip.if === true) {
	    return false;
	  }

	  var include = (0, values$2.getDirectiveValues)(directives.GraphQLIncludeDirective, node, exeContext.variableValues);
	...
	function resolveFieldValueOrError(exeContext, fieldDef, fieldNodes, resolveFn, source, info) {
	  try {
	    ...
	    var args = (0, values$2.getArgumentValues)(fieldDef, fieldNodes[0], exeContext.variableValues);
	...
	function completeValueWithLocatedError(exeContext, returnType, fieldNodes, info, path, result) {
	  try {
	    ...
	    var promise = getPromise(completed);
	    if (promise) {
	      return promise.then(undefined, function (error$1) {
	        return Promise.reject((0, error.locatedError)(error$1, fieldNodes, responsePathAsArray(path)));
	      });
	    }
	    return completed;
	  } catch (error$1) {
	    throw (0, error.locatedError)(error$1, fieldNodes, responsePathAsArray(path));
	  }
	}
	...
	function getFieldDef(schema, parentType, fieldName) {
	  if (fieldName === introspection.SchemaMetaFieldDef.name && schema.getQueryType() === parentType) {
	    return introspection.SchemaMetaFieldDef;
	  } else if (fieldName === introspection.TypeMetaFieldDef.name && schema.getQueryType() === parentType) {
	    return introspection.TypeMetaFieldDef;
	...
	var execute_2 = execute_1.defaultFieldResolver;
	var execute_3 = execute_1.execute;
	var execute_4 = execute_1.responsePathAsArray;
	var execute_5 = execute_1.addPath;
	var execute_6 = execute_1.assertValidExecutionArguments;
	var execute_7 = execute_1.buildExecutionContext;
	var execute_8 = execute_1.getOperationRootType;
	var execute_9 = execute_1.collectFields;
	var execute_10 = execute_1.buildResolveInfo;
	var execute_11 = execute_1.resolveFieldValueOrError;
	var execute_12 = execute_1.getFieldDef;
	...
	Object.defineProperty(exports, 'getDirectiveValues', {
	  enumerable: true,
	  get: function get() {
	    return values$2.getDirectiveValues;
	  }
	});
	});
	...
	function subscribeImpl(schema, document, rootValue, contextValue, variableValues, operationName, fieldResolver, subscribeFieldResolver) {
	  ...
	  var mapSourceToResponse = function mapSourceToResponse(payload) {
	    return (0, execute_1.execute)(schema, document, payload, contextValue, variableValues, operationName, fieldResolver);
	  };
	...
	function createSourceEventStream(schema, document, rootValue, contextValue, variableValues, operationName, fieldResolver) {
	  ...
	  return new Promise(function (resolve, reject) {
	    ...
	    var exeContext = (0, execute_1.buildExecutionContext)(schema, document, rootValue, contextValue, variableValues, operationName, fieldResolver);

	    var type = (0, execute_1.getOperationRootType)(schema, exeContext.operation);
	    ...
	    var fieldNodes = fields[responseName];
	    var fieldNode = fieldNodes[0];
	    var fieldDef = (0, execute_1.getFieldDef)(schema, type, fieldNode.name.value);
	...
	var introspectionQuery_2 = introspectionQuery_1.introspectionQuery;
	 ...
	 */
	function buildClientSchema(introspection$1) {

	  // Get the schema from the introspection result.
	  var schemaIntrospection = introspection$1.__schema;
	  ...
	  var directives$1 = schemaIntrospection.directives ? schemaIntrospection.directives.map(buildDirective) : [];
	...
	function buildASTSchema(ast) {
	  ...
	  var directives$1 = directiveDefs.map(getDirective);
	...
	function getDeprecationReason(node) {
	  var deprecated = (0, values$2.getDirectiveValues)(directives.GraphQLDeprecatedDirective, node);
	...
	var buildASTSchema_3 = buildASTSchema_1.getDeprecationReason;
	var buildASTSchema_4 = buildASTSchema_1.getDescription;
	var buildASTSchema_5 = buildASTSchema_1.buildSchema;
	...
	function extendSchema(schema$1, documentAST) {
	  !(schema$1 instanceof schema.GraphQLSchema) ? (0, _invariant2.default)(0, 'Must provide valid GraphQLSchema') : void 0;
	  ...
	  var queryType = getTypeFromDef(schema$1.getQueryType());

	  var existingMutationType = schema$1.getMutationType();
	  var mutationType = existingMutationType ? getTypeFromDef(existingMutationType) : null;

	  var existingSubscriptionType = schema$1.getSubscriptionType();
	  var subscriptionType = existingSubscriptionType ? getTypeFromDef(existingSubscriptionType) : null;

	  // Iterate through all types, getting the type definition for each, ensuring
	  // that any type not directly referenced by a field will get created.
	  var typeMap = schema$1.getTypeMap();
	  ...
	  function getMergedDirectives() {
	    var existingDirectives = schema$1.getDirectives();
	...
	var findBreakingChanges_2 = findBreakingChanges_1.DangerousChangeType;
	var findBreakingChanges_3 = findBreakingChanges_1.BreakingChangeType;
	var findBreakingChanges_4 = findBreakingChanges_1.findBreakingChanges;
	var findBreakingChanges_5 = findBreakingChanges_1.findDangerousChanges;
	var findBreakingChanges_6 = findBreakingChanges_1.findRemovedTypes;
	var findBreakingChanges_7 = findBreakingChanges_1.findTypesThatChangedKind;
	var findBreakingChanges_8 = findBreakingChanges_1.findArgChanges;
	var findBreakingChanges_9 = findBreakingChanges_1.findFieldsThatChangedType;
	var findBreakingChanges_10 = findBreakingChanges_1.findFieldsThatChangedTypeOnInputObjectTypes;
	var findBreakingChanges_11 = findBreakingChanges_1.findTypesRemovedFromUnions;
	var findBreakingChanges_12 = findBreakingChanges_1.findTypesAddedToUnions;
	var findBreakingChanges_13 = findBreakingChanges_1.findValuesRemovedFromEnums;
	var findBreakingChanges_14 = findBreakingChanges_1.findValuesAddedToEnums;
	var findBreakingChanges_15 = findBreakingChanges_1.findInterfacesRemovedFromObjectTypes;
	...
	function findDeprecatedUsages(schema, ast) {
	  var errors = [];
	  var typeInfo = new TypeInfo_1.TypeInfo(schema);
	...
	var graphql_1$1 = graphql.parse;
	var graphql_2$1 = graphql.graphql;
	...
	var DateType = new graphql_13({
	  ...
	  parseLiteral: function parseLiteral(ast) {
	    ...
	    if (ast.kind !== language_13.STRING) {
	      throw new graphql_5("Query error: Can only parse dates strings, got a: ".concat(ast.kind), [ast]);
	    }
	...
	var isArray$2 = function isArray(value) {
	  return isArray$1(value);
	};

	var valuesAreArray = function valuesAreArray(values) {
	  return values.every(isArray$2);
	};
	...
	var getValuesFromEntities = (function (entities) {
	  return entities.reduce(function (values, entity) {
	    keys$1(entity).forEach(function (fieldName) {
	      if (!values[fieldName]) {
	        values[fieldName] = [];
	      }
	...
	var getFieldsFromEntities = (function (entities) {
	  ...
	  return keys$1(fieldValues).reduce(function (fields, fieldName) {
	    fields[fieldName] = {
	...
	var getTypesFromData = (function (data) {
	  return keys$1(data).map(function (typeName) {
	    return {
	...
	var getFilterTypesFromData = (function (data) {
	  return keys$1(data).reduce(function (types, key) {
	    return assign$1({}, types, defineProperty$2({}, getTypeFromKey(key), new graphql_8({
	...
	var getSchemaFromData = (function (data) {
	  ...
	  var mutationType = new graphql_12({
	    ...
	    fields: types.reduce(function (fields, type) {
	      ...
	      var nullableTypeFields = keys$1(typeFields).reduce(function (f, fieldName) {
	        f[fieldName] = assign$1({}, typeFields[fieldName], {
	  ...
	  var schemaExtension = values$1(typesByName).reduce(function (ext, type) {
	    keys$1(type.getFields()).filter(isRelationshipFieldImport).map(function (fieldName) {
	  ...
	  return schemaExtension ? graphql_3(schema, graphql_1$1(schemaExtension)) : schema;
	});
